-- Create employee push tokens table
...
-- Create authentication requests table
...
CREATE INDEX IF NOT EXISTS idx_employee_push_tokens_employee_id ON employee_push_tokens(employee_id);
CREATE INDEX IF NOT EXISTS idx_employee_push_tokens_active ON employee_push_tokens(is_active) WHERE is_active = true;
CREATE INDEX IF NOT EXISTS idx_auth_requests_employee_id ON auth_requests(employee_id);
...
CREATE INDEX IF NOT EXISTS idx_push_notification_logs_employee_id ON push_notification_logs(employee_id);
...
DECLARE
  ...
  notification_employee_id INTEGER;
BEGIN
  -- Get task details
