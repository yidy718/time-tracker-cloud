-- Fix push notification tables to use UUID foreign keys for BOTH employees AND tasks
-- This corrects all foreign key references to match UUID types
...
-- Create task notifications table with UUID foreign keys for BOTH tasks AND employees
