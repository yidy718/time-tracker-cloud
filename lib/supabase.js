...
export const database = {
  ...
  authenticateEmployee: async (username, password) => {
    ...
    if (!error && data && data.length > 0) {
      ...
      console.log('Raw employee data from function:', employee)
      console.log('Employee can_expense field:', employee.can_expense)
      ...
      console.log('Processed can_expense:', processedData.can_expense)
  ...
  getCurrentEmployee: async (userId) => {
    ...
    console.log('🔍 getCurrentEmployee called with userId:', userId)
    ...
    if (data) {
      console.log('🔍 getCurrentEmployee returning employee:', {
        id: data.id,
        email: data.email,
        can_expense: data.can_expense,
        role: data.role
      })
    }
  ...
  getCurrentEmployeeByEmail: async (email) => {
    console.log('🔍 getCurrentEmployeeByEmail called with email:', email)
    ...
    if (data) {
      console.log('🔍 getCurrentEmployeeByEmail returning employee:', {
        id: data.id,
        email: data.email,
        can_expense: data.can_expense,
        role: data.role
