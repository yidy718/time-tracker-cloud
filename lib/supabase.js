...
export const database = {
  ...
  clockIn: async (employeeId, projectId, locationId = null) => {
    try {
      // Support location selection for projects with multiple locations
      const sessionData = {
      ...
      // Add location_id if provided (for projects with multiple locations)
      if (locationId) {
        sessionData.location_id = locationId
      }
